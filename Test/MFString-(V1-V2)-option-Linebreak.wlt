...
VerificationTest[
    MFString[(e + f)/((-a + b)*(c + d)), "Method" -> "V1"]
    ,
    "\\frac{\n    e+f\n}{\n    (b-a)\n    (c+d)\n}"
    ,
...
VerificationTest[
    MFString[(e + f)/((-a + b)*(c + d)), "Method" -> "V2"]
    ,
    "\\frac{e+f}{\n    (b-a)\n    (c+d)\n}"
    ,
...
VerificationTest[
    ...
    "-s t\nf(a b c)\n-s u\nf(a c d)"
    ,
    TestID->"[37] MFString-(V1-V2)-option-Linebreak.nb"
]
...
VerificationTest[
    ...
    "-s t\nf(a b c)\n-2 s u\nf(a c d)"
    ,
    TestID->"[38] MFString-(V1-V2)-option-Linebreak.nb"
]
...
VerificationTest[
    ...
    "1\n-(-1)^a s t\nf(a b c d)"
    ,
    TestID->"[39] MFString-(V1-V2)-option-Linebreak.nb"
]
